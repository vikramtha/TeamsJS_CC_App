      ...
      <Fluent.Flex column={true} gap={"gap.small"} padding={"padding.medium"} >
        ...
        <Fluent.Segment>
          <Fluent.Flex gap="gap.small" styles={{ justifyContent: 'space-between' }}>
            ...
            <Fluent.Flex.Item>
              <Fluent.Button onClick={() => downloadCapabilitiesCSV()}><Fluent.ExcelColorIcon />Download .csv</Fluent.Button>
            </Fluent.Flex.Item>
          </Fluent.Flex>
        </Fluent.Segment>
